# Capability: stage-2-demo-publishing

## Purpose

Define how the Stage 2 PoC is published to a stable public GitHub Pages URL so the team can share and demo the first-ASIN flow without running a local environment.
