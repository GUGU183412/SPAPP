# Capability: stage-3-navigation-control-center

## Purpose

Define the Stage 3 navigation utilities for context-safe home return, targeted pre-session editing, and preview-only page switching.
