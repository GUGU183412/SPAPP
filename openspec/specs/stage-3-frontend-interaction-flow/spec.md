# Capability: stage-3-frontend-interaction-flow

## Purpose

Define the Stage 3 MVP front-end page sequence, gating rules, recovery behavior, and short-cycle delivery contract for the goal-driven training experience.
