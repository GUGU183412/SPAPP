# Capability: resolution-feedback-loop

## Purpose

Define how the guided installation experience captures resolved and unresolved outcomes, gathers structured follow-up reasons, and routes users to the next best recovery action.
