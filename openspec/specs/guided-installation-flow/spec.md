# Capability: guided-installation-flow

## Purpose

Define the Stage 2 guided installation flow for the first door anchor strap SKU so users can enter from scan, complete the 3-step tutorial, and reach the feedback loop.
