...
- 首批 ASIN：`B0BXJLTRSH`
- GitHub Pages 公开演示链接：
  `https://gugu183412.github.io/SPAPP/?asin=B0BXJLTRSH&src=qr`
- 阶段二二维码资产：
  `docs/stages/stage-2/assets/qr/stage2-demo-qr.png`
  `docs/stages/stage-2/assets/qr/stage2-demo-qr.svg`
- 页面闭环：
...
> 当前公开演示链接与二维码已经就绪，下一步一方面可以补正式演示录屏，另一方面阶段三优先聚焦 4 件事：强化 Step 1 防打滑内容、接入正式埋点平台、完成内容配置化、把 PoC 提示页升级成正式产品状态页。
